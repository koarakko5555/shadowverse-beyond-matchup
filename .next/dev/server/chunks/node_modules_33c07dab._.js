...
"[project]/node_modules/camelize/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var parse = __turbopack_context__.r("[project]/node_modules/postcss-value-parser/lib/index.js [app-route] (ecmascript)");
var parse__default = _interopDefault(parse);
var camelizeStyleName = _interopDefault(__turbopack_context__.r("[project]/node_modules/camelize/index.js [app-route] (ecmascript)"));
var cssColorKeywords = _interopDefault(__turbopack_context__.r("[project]/node_modules/css-color-keywords/index.js [app-route] (ecmascript)"));
...
"[project]/node_modules/css-background-parser/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
// };
    ...
    // CommonJS
    if (("TURBOPACK compile-time value", "object") !== 'undefined' && module.exports !== undefined) return module.exports;
    // Global `cssBgParser`
    return root.cssBgParser = {};
}(/*TURBOPACK member replacement*/ __turbopack_context__.e));
}),
"[project]/node_modules/css-box-shadow/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const stringifyValue = (obj)=>{
    ...
    return [
        ...
        spreadRadius,
        color
    ].filter((v)=>v !== null && v !== undefined).map(toPx).map((s)=>('' + s).trim()).join(' ');
};
...
"[project]/node_modules/hex-rgb/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/parse-css-color/dist/index.esm.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$name$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/color-name/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hex$2d$rgb$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/hex-rgb/index.js [app-route] (ecmascript)");
;
;
...
function getHEX(hex) {
    const [r, g, b, a] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hex$2d$rgb$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(hex, {
        format: 'array'
    });
    return getRGB([
        null,
 ...
 */ const parseCSSColor = (str)=>{
    ...
    const cn = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$color$2d$name$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"][str.toLowerCase()];
    if (cn) return getRGB([
        null,
        cn[0],
        cn[1],
...
const __TURBOPACK__default__export__ = parseCSSColor;
}),
...
"[project]/node_modules/css-gradient-parser/dist/index.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function S(e) {
    return /(circle|ellipse|at)/.test(e) ? !1 : /^(rgba?|hwb|hsl|lab|lch|oklab|color|#|[a-zA-Z]+)/.test(e);
}
var C = new Set([
    "from",
    "in",
...
function y(e, o, t, n) {
    switch(e){
        case "from":
            return {
                angle: o.slice(t, n).join(" ")
            };
        case "at":
            return {
                position: o.slice(t, n).join(" ")
            };
        case "in":
            {
                let [i, ...r] = o.slice(t, n);
...
//# sourceMappingURL=node_modules_33c07dab._.js.map