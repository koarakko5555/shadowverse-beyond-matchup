...
"[project]/app/api/matchups/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const isValidWinRate = (value)=>Number.isInteger(value) && value >= 0 && value <= 100 && value % 5 === 0;
async function GET() {
    const matchups = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchup.findMany({
        orderBy: {
            id: "desc"
        },
        include: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(matchups);
}
async function POST(request) {
    ...
    const deck1Id = typeof body?.deck1Id === "number" ? body.deck1Id : undefined;
    const deck2Id = typeof body?.deck2Id === "number" ? body.deck2Id : undefined;
    ...
    const matchup = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchup.upsert({
        where: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(matchup, {
        status: 201
    });
}
__turbopack_async_result__();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5ceae0b1._.js.map