...
function SignupPage() {
    ...
    const onSubmit = async (event)=>{
        ...
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSupabaseBrowserClient"])();
        const { data, error: signUpError } = await supabase.auth.signUp({
            email: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["idToEmail"])(loginId),
            password
        });
        if (signUpError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9339c63f._.js.map