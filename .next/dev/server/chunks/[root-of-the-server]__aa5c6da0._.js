...
"[project]/app/api/match-records/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const isValidTurn = (value)=>value === "FIRST" || value === "SECOND";
const isValidResult = (value)=>value === "WIN" || value === "LOSS";
const fetchDecks = async (deckId, opponentDeckId)=>{
    ...
    const byId = new Map(decks.map((deck)=>[
            deck.id,
            deck
        ]));
...
async function PUT(request, { params }) {
    ...
    const opponentDeckId = typeof body?.opponentDeckId === "number" ? body.opponentDeckId : undefined;
    ...
    const record = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchRecord.update({
        where: {
            id
        },
        data: {
...
async function DELETE(_, { params }) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].matchRecord.delete({
        where: {
            id
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa5c6da0._.js.map